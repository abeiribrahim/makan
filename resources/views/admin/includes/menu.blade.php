			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.html" class="site_title"><i class="fa fa-car"></i> <span>Makaan Admin</span></a>
					</div>
...
<div class="profile clearfix">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-users"></i> Team <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('admin.team')}}">Team List</a></li>
										<li><a href="{{route('admin.addteam')}}">Add Team</a></li>
									</ul>
								</li>
								...
								<li><a><i class="fa fa-desktop"></i> Property <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('addproperty')}}">Add Property</a></li>
										<li><a href="{{route('admin.propertylist')}}">Properies </a></li>
									</ul>
								</li>
                <li><a><i class="fa fa-desktop"></i> Testimonials <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="{{route('admin.testi')}}">Edit Testimonials</a></li>
									</ul>
								</li>
